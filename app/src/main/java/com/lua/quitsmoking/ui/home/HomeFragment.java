...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        btn_gravar.setOnClickListener(v -> {
            if(!Objects.requireNonNull(edtxt_intervalo.getText()).toString().equals("")){
                if(!Objects.requireNonNull(edtxt_incremento.getText()).toString().equals("")){
                    ...
                    if(mainActivity != null){
                        Snackbar.make(mainActivity.findViewById(android.R.id.content),getString(R.string.intervaloguardado), Snackbar.LENGTH_LONG)
                                .setAction("Action", null).show();
                    }

                }else {
                    if(mainActivity != null){
                        Snackbar.make(mainActivity.findViewById(android.R.id.content), getString(R.string.preencheotempoaincrementar), Snackbar.LENGTH_LONG)
                                .setAction("Action", null).show();
                    }
                }
            }else {
                if(mainActivity != null){
                    Snackbar.make(mainActivity.findViewById(android.R.id.content), getString(R.string.preencheointervalodetempo), Snackbar.LENGTH_LONG)
                            .setAction("Action", null).show();
                }
            }
        });
